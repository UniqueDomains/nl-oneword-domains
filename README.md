# Available .NL One-Word Domains (5,621,926)
...
> **Important:** this repository is a **public 659-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,926 domains** on the canonical page below.

**Public extract:** 659 rows · **Live catalog:** 5,621,926 domains
...
| remove.nl       | premium   | $4,093.63 | —             | 82             | 16     | 6      | SmartLogic                       |
...
| older.nl        | premium   | $1,098.25 | $11.99        | 66             | 11     | 5      | Metaregistrar B.V.               |
...
| --------------------- | ------------------------------------------------ |
| 659-row public sample | 5,621,926 live domains                           |
...
> Unique Domains. *Available .NL One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
