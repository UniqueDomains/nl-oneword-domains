# Available .NL One-Word Domains (8,504)
...
> The full live catalog for this exact search currently contains **8,504 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 8,504 domains · **Median ask:** $13.54 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 8,504 live domains                         |
...
> Unique Domains. *Available .NL One-Word Domains*. Version 2026-08-22. Public GitHub extract for the exact Unique Domains search represented by this repository.
