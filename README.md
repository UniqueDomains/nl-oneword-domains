# Available .NL One-Word Domains (9,291)
...
> The full live catalog for this exact search currently contains **9,291 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 9,291 domains · **Median ask:** $13.43 · **High-demand under $2,500:** 0
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 9,291 live domains                         |
...
> Unique Domains. *Available .NL One-Word Domains*. Version 2026-09-03. Public GitHub extract for the exact Unique Domains search represented by this repository.
